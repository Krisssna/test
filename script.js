...
function loadMorePlaylists() {
  ...
  playlist.innerHTML = `
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/videoseries?list=PLELAQjFzxU_4KIqHW9KzB58p-fCeZii8s${playlistCount}" frameborder="0" allowfullscreen></iframe>
  `;
